  ...
  return (
    <>
      ...
      <main className="container">
        ...
        {!token && <div className="card">Login to add, edit, or delete tasks.</div>}
        <form onSubmit={handleCreateTask} style={{ marginBottom: '2rem' }}>
          <div className="form-group">
            <label htmlFor="task-title">Task Title</label>
            <input id="task-title" type="text" value={title} onChange={e => setTitle(e.target.value)} placeholder="e.g., Buy milk" />
          </div>
          <div className="form-group">
            <label htmlFor="task-category">Category</label>
            <select id="task-category" value={category} onChange={e => { setCategory(e.target.value); setSubcategory(''); }}>
          ...
          {category && categories[category] && (
            <div className="form-group">
              ...
              <select id="task-subcategory" value={subcategory} onChange={e => setSubcategory(e.target.value)}>
                <option value="">None</option>
